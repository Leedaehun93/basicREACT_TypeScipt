// TODO : 자식 컴포넌트./pages/02_exam/ Etc.js
// TODO : typescript 내장함수
...
function Etc() {
  ...
  type alisuUser = string | number;
  let person: alisuUser = "hong";
  console.log(person);

  // TODO: 5) 타입 추론 : 모든 변수에 자료형을 지정하지 않아도 값으로 추론하는 기능을 부여
  // TODO : (1) 변수의 초기값 : 생략가능
  // let num:number = 10; // 사용가능
  let num = 10; // 생략 사용가능
  ...
  function someFunc(val: string | number, isNumber: boolean) {
    // TODO: 가정 : isNumber 가 true 이면 무조건 val 값은 정수가 된다고 확신
    if (isNumber === true) {
